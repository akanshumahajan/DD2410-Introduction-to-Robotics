...
class StateMachine(object):
    def __init__(self):
        ...
        self.marker_pose_nm = rospy.get_param('/robotics_intro/manipulation_client/marker_pose_topic')
    ...
    def check_states(self):
        ...
        while not rospy.is_shutdown() and self.state != 3:
            ...
            if self.state == 1:
                ...
                try:
                    ...
                    print "Service call to pick_service server failed: %s"%e

            # State 2:  Move the robot "manually" to table
            if self.state == 2:
                move_msg = Twist()
            ...
            if self.state == 3:
            	try:
                    ...
                    print "Service call to place_service server failed: %s"%e
